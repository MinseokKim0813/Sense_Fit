...
class Popup_OK_Only(QDialog):
    def __init__(self, message="Default Message", window_title="Warning", title="Alert",ok_button_text="OK"):
        super().__init__()
        ...
        icon_path = os.path.join(current_dir, "Images", "caution.png")
